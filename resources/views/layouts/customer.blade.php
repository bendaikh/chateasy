        ...
        <aside class="w-64 bg-[#0f1c2e] border-r border-white/10 flex-shrink-0">
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto" x-data="{ socialMediaOpen: false, aiApiOpen: false, productsOpen: {{ request()->routeIs('app.products*') || request()->routeIs('app.categories*') ? 'true' : 'false' }} }">
                    ...
                    <div>
                        <button @click="socialMediaOpen = !socialMediaOpen" class="w-full text-gray-400 hover:bg-white/5 flex items-center justify-between px-3 py-2.5 rounded-lg transition">
                            <div class="flex items-center gap-3">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="#" class="text-gray-400 hover:bg-white/5 flex items-center gap-3 px-3 py-2.5 rounded-lg transition">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
